    ...
    def check_url(self, url: str) -> ThreatIntelResult:
        ...
        try:
            ...
            return ThreatIntelResult(
                ...
                malicious=None,
                score=None,
                details="VirusTotal timed out before returning a result.",
                error="network_error",
            )
        ...
        try:
            ...
            if not isinstance(payload, dict):
                raise TypeError("VirusTotal returned a non-object response")
        ...
        try:
            ...
            return ThreatIntelResult(
                ...
                malicious=None,
                score=None,
                details="VirusTotal returned a malformed response structure.",
                error="invalid_response",
            )
